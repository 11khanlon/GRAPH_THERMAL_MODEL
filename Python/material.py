...
class Ti64Material:
    ...
    def __init__(self):
        ...
        # Density (constant)
        self.rho = MATERIAL["density"]      # kg/m^3
        ...
        self.k_table = np.array([
            6.7, 7.0, 7.5, 8.0, 8.7, 9.3, 10.0, 10.7, 11.5,
            12.3, 13.0, 13.8, 14.5, 15.0, 15.6, 16.0, 16.5])

        # Specific heat (J/kg-K)

        self.cp_table = np.array([
            560, 600, 640, 675, 710, 740, 770, 790,
            810, 825, 840, 850, 860, 865, 870, 875, 880 ])
    ...
    def conductivity(self, T):
        ...
        return np.interp(T, self.temperature_table, self.k_table)
    ...
    def specific_heat(self, T):
        ...
        return np.interp(T, self.temperature_table, self.cp_table)
    ...
    def diffusivity_linear_si(self, T):
        ...
        return (self.diffusivity_linear(T) * 1e-6)


    # -------- Average layer diffusivity -----------------

    def layer_diffusivity(self, temperatures):
    ...
    def summary(self):
        ...
        print(f"k(25°C) = {self.conductivity(25):.2f} W/m-K")

        print(f"Cp(25°C) = {self.specific_heat(25):.1f} J/kg-K")
...
if __name__ == "__main__":
    ...
    temperatures = np.linspace(25, 1600, 10)
    ...
    for T in temperatures:
        ...
        print(f"{T:7.1f} °C | "
            ...
            f"alpha = {material.diffusivity_linear_si(T):.3e}") 