...
class DepositionSimulation:
    ...
    def __init__(self,
        ...
        self.temperature = np.full(len(nodes),
    ...
    def simulate_block(self, block):
        ...
        self.temperature = (
            self.cooling.block_cooling(self.temperature, 
            self.surface_mask(),
...
if __name__ == "__main__":
    ...
    from config import (MATERIAL, LASER, GRAPH, CONVECTION)
    ...
    simulation = DepositionSimulation(
        geometry, generator.nodes, graph,
        MATERIAL, LASER, CONVECTION, GRAPH)
